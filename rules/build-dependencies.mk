...
$$($1_$2_depfile_haskell) : $$(includes_H_AUTOCONF) $$(includes_H_CONFIG) $$(includes_H_PLATFORM)
...
# includes files.
$$($1_$2_depfile_c_asm) : $$(includes_H_AUTOCONF) $$(includes_H_CONFIG) $$(includes_H_PLATFORM)
